...
const ContentForFooter = {
	...
	'thx': [
		["If you would like to get in touch with me:", "Please send your request through the contact form. I will respond directly from my operational email, providing my phone number for further conversation. Unfortunately, due to a high volume of spam, I use the contact form as a shield and do not disclose my phone number or email address on the website."],
		["If you are interested in a completely new, customized project:", "Please describe your needs, especially the product you would like me to create for you. It would be beneficial if you could include photographs or links to materials that might inspire me. Based on this, I will estimate the cost of creating a 3D project in the MVP phase. If you approve of the project and wish to continue, be aware that the next steps involve creating a model, preparing a casting mold, and then beginning the concrete casting process. Yes, casting objects in concrete is a time-consuming and somewhat expensive endeavor."],
		["If you want to provide feedback:", "Feel free to write anything you wish. I am happy to answer all questions and share experiences related to concrete casting. Please note that I will not respond to spammers or haters, whom I also greet."],
	],
}
